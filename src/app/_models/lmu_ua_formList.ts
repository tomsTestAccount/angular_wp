...
export class lmu_ua_formList {
    ...
    public handleFormObject2SendToServer(uaObjLocal:any) {
        ...
        else
        {
            ...
            if (uaObjLocal.subFormGroup_apd[0] != undefined)
            {
                for (let p in uaObjLocal.subFormGroup_apd[0])
                {
                    let sendStruct = this._conversionsAndChecks4Obj2Server(uaObjLocal.subFormGroup_apd[0],p);
            ...
            if (uaObjLocal.subFormGroup_ac[0] != undefined)
            {
                for (let p in uaObjLocal.subFormGroup_ac[0])
                {
                    let sendStruct= this._conversionsAndChecks4Obj2Server(uaObjLocal.subFormGroup_ac[0],p);
                    if (sendStruct.send) tmpUaObj2Server[p] = sendStruct.value;
                }
            }
            else console.log("ERROR in auth_handleFormObject4SendToServer, uaObjLocal.subFormGroup_ac[0] == undefined !!!!");

            if (uaObjLocal.subFormGroup_ac2[0] != undefined)
            {


                for (let p in uaObjLocal.subFormGroup_ac2[0])
                {
                    let sendStruct= this._conversionsAndChecks4Obj2Server(uaObjLocal.subFormGroup_ac2[0],p);
                    if (sendStruct.send) tmpUaObj2Server[p] = sendStruct.value;
            ...
            if (uaObjLocal.subFormGroup_oi[0] != undefined)
            {

                for (let p in uaObjLocal.subFormGroup_oi[0])
                {
                    let sendStruct= this._conversionsAndChecks4Obj2Server(uaObjLocal.subFormGroup_oi[0],p);
                    if (sendStruct.send) tmpUaObj2Server[p] = sendStruct.value;
                }
            }
