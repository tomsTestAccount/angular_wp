...
var LoginComponent = (function () {
    ...
    LoginComponent.prototype.closeModal = function (gotoUrl) {
        this.bShowModal = false;
        this.error = '';
        this.result = '';
    ...
    */
    LoginComponent.prototype.login = function () {
        ...
        this.authenticationService.login_getToken(userId, this.loginForm.controls['password'].value)
            ...
            _this.closeModal('/userApplication');
        })
            .catch(function (error) {
    ...
    LoginComponent = __decorate([
        ...
        __metadata('design:paramtypes', [forms_1.FormBuilder, rt_authentication_service_1.AuthenticationService, rt_rest_service_1.RestService, router_1.Router, router_1.ActivatedRoute, common_1.Location])
    ], LoginComponent);
