...
var lmu_ua_formList = (function () {
    ...
    lmu_ua_formList.prototype.buildFormObject_apd = function () {
        var formGroup = this.formSrv.toFormGroup(this.get_formEntries_apd());
        console.log("In buildFormObject_apd,this.get_formEntries_apd=", formEntries_apd);
        return new rt_forms_service_1.cFormObject(formGroup, this.get_formEntries_apd());
    };
    lmu_ua_formList.prototype.buildFormObject_ac = function () {
        var formGroup = this.formSrv.toFormGroup(this.get_form_ac());
        //console.log("formGroup_ac=",formGroup);
        return new rt_forms_service_1.cFormObject(formGroup, this.get_form_ac());
    };
    lmu_ua_formList.prototype.buildFormObject_ac2 = function () {
        var formGroup = this.formSrv.toFormGroup(this.get_from_ac2());
        //console.log("formGroup_ac=",formGroup);
        return new rt_forms_service_1.cFormObject(formGroup, this.get_from_ac2());
    };
    lmu_ua_formList.prototype.buildFormObject_oi = function () {
        var formGroup = this.formSrv.toFormGroup(this.get_form_oi());
        //console.log("formGroup_ac=",formGroup);
        return new rt_forms_service_1.cFormObject(formGroup, this.get_form_oi());
    };
    //--------------------------------------------------------------------------
    lmu_ua_formList.prototype.set_formEntryValue = function (key, value) {
    ...
    // ----------------------------------------------------------------------
    lmu_ua_formList.prototype.get_formEntries_apd = function () {
    ...
    */
    ...
    lmu_ua_formList.prototype.get_form_ac = function () {
    ...
    */
    ...
    lmu_ua_formList.prototype.get_form_oi = function () {
    ...
    */
    ...
    lmu_ua_formList.prototype.get_from_ac2 = function () {
